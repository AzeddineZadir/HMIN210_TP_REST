...
namespace ServiceHotelRest.Service
{
    public class HotelService
    {
        ...
        public string SendImage(int id)
        {
            ...
            System.Drawing.Image image = System.Drawing.Image.FromFile(Environment.CurrentDirectory+"\\Images" + "\\im_" + id + ".jpg");


            Console.WriteLine(Environment.CurrentDirectory + "Images" + "\\im_" + id + ".jpg***********************************************************************************");
            Console.WriteLine(Environment.CurrentDirectory + "Images" + "\\im_" + id + ".jpg***********************************************************************************");
            Console.WriteLine(Environment.CurrentDirectory + "Images" + "\\im_" + id + ".jpg***********************************************************************************");
        ...
        public List<Rome> addImages(List<Rome> roomes)
        {
            ...
            foreach (var item in roomes)
            {
                ...
                System.Drawing.Image image = System.Drawing.Image.FromFile(Environment.CurrentDirectory+"Images" + "\\im_" + item.Id + ".jpg");
                System.IO.MemoryStream stream = new System.IO.MemoryStream();
                image.Save(stream, System.Drawing.Imaging.ImageFormat.Png);
                byte[] imageByte = stream.ToArray();
                imageStr = Convert.ToBase64String(imageByte);
